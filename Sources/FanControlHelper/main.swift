...
private final class FanControlOwnership {
    private let lockPath = "/var/run/kryon-fan-control.lock"
    private let markerPath = "/var/run/kryon-fan-control.active"
...
private final class FanControlController {
    private let queue = DispatchQueue(label: "com.kryon.fan-control.helper")
