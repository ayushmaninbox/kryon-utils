...
/// Quick subsystem check, run with `Kryon --selftest`.
...
enum SelfTest {
    static func runAndExit() -> Never {
        ...
        if Bundle.main.url(forResource: "MenuBarIconBlack", withExtension: "png") == nil
            || Bundle.main.url(forResource: "MenuBarIconWhite", withExtension: "png") == nil {
...
/// classification. Run with `Kryon --sensors`; handy when porting
