...
enum UpdateShowcaseInfo {
    ...
    static let mediaAssetName = "kryon-3.1.4-showcase-1.mp4"

    static var remoteMediaURL: URL {
        URL(string: "https://github.com/kryon/kryon-utils/releases/download/v\(releaseVersion)/\(mediaAssetName)")!
    }
    ...
    static var localDeveloperMediaURL: URL? {
        ...
        let desktopDemo = URL(fileURLWithPath: "/Users/kryon/Desktop/demo.gif")
    ...
    static var cacheDirectory: URL {
        ...
        let bundleID = Bundle.main.bundleIdentifier ?? "com.kryon.utils"
        return base
