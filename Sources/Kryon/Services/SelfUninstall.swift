...
enum SelfUninstall {
    private static var bundleID: String { Bundle.main.bundleIdentifier ?? "com.kryon.utils" }
    ...
    /// bundle to the Trash and quits. Used by "Uninstall Kryon completely".
    ...
    private static func trashOwnBundleAndQuit() {
        ...
        let scriptURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("kryon-uninstall-\(pid)-\(UUID().uuidString).sh")
        do {
