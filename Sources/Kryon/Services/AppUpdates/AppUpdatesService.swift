...
final class AppUpdatesService: ObservableObject {
    ...
    private let workQueue = DispatchQueue(label: "com.kryon.appupdates", qos: .utility)
    ...
    private static func isOwnBundle(_ bundleID: String) -> Bool {
        bundleID == Bundle.main.bundleIdentifier || bundleID.hasPrefix("com.kryon")
    }

    private static let ownPackageTokens: Set<String> = ["kryon", "kryon@beta", "kryon-beta"]
