...
enum Notifier {
    static let whatsAppOrganizerUndoActionIdentifier =
        "com.kryon.notification.whatsapp-organizer.undo"
    private static let whatsAppOrganizerTransactionKey =
        "com.kryon.notification.whatsapp-organizer.transaction"
    private static let whatsAppOrganizerCategoryIdentifier =
        "com.kryon.notification.whatsapp-organizer"
    private static let log = Logger(subsystem: Bundle.main.bundleIdentifier ?? "kryon",
