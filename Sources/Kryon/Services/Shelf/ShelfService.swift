...
final class ShelfService: ObservableObject {
    ...
    private let tempDir: URL = {
        let id = Bundle.main.bundleIdentifier ?? "com.kryon.utils"
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("KryonShelf", isDirectory: true)
    ...
    private static let persistQueue = DispatchQueue(label: "com.kryon.utils.shelf-persist",
                                                    qos: .utility)
