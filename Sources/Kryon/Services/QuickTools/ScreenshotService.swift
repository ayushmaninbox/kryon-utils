...
final class ScreenshotService: ObservableObject {
    ...
    private var hideKryonWindows: Bool {
        UserDefaults.standard.bool(forKey: DefaultsKey.screenshotHideKryonWindows)
    }
    ...
    private func beginSelection(_ mode: CaptureMode) {
        ...
        let controller = ScreenshotSelectionController(
            ...
            hideKryonWindows: hideKryonWindows,
    ...
    private func beginFullScreenCapture() {
        ...
        let hideWindows = hideKryonWindows
...
enum ScreenshotLastCaptureStore {
    private static let writeQueue = DispatchQueue(
        label: "com.kryon.utils.latest-screenshot",
        qos: .utility)
