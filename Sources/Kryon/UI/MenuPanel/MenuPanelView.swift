...
extension Notification.Name {
    static let menuPanelWillShow = Notification.Name("KryonMenuPanelWillShow")
}
...
struct KeepAwakeCard: View {
    ...
    @AppStorage(DefaultsKey.keepAwakeActiveIcon) private var keepAwakeActiveIcon = KeepAwakeActiveIcon.kryon.rawValue
