...
enum DefaultsKey {
    ...
    static let screenshotHideKryonWindows = "screenshotHideKryonWindows"
...
enum KeepAwakeActiveIcon: String, CaseIterable, Identifiable {
    case kryon, coffee, eye, moon, light
    ...
    var menuBarDrop: CGFloat {
        ...
        case .kryon, .eye, .moon: return 0
        }
    }

    func title(_ strings: Strings) -> String {
        switch self {
        case .kryon: return strings.keepAwakeActiveIconKryon
...
enum Defaults {
    ...
    static let registeredDefaults: [String: Any] = [
        ...
        DefaultsKey.keepAwakeActiveIcon: KeepAwakeActiveIcon.kryon.rawValue,
        ...
        DefaultsKey.screenshotHideKryonWindows: true,
