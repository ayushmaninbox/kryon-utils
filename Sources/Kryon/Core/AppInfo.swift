...
enum AppInfo {
    static let name = "Kryon"
    static let copyright = "© 2026 Ayushman Mohapatra"
    ...
    /// True for the local "Kryon (Developer)" build (bundle id ends in `.dev`).
    ...
    static var buildCommit: String? {
        Bundle.main.object(forInfoDictionaryKey: "KryonBuildCommit") as? String
    }
}
