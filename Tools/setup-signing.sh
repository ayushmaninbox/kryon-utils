...
# Creates a stable, self-signed code-signing identity named "Kryon Utils
...
#
# This identity name keeps its original "Kryon Utils Signing" on purpose: it
...
IDENTITY="Kryon Utils Signing"
KC="$HOME/Library/Keychains/kryon-signing.keychain-db"
KCPASS="kryon-signing"
